...
const client = new request.GraphQLClient('https://major-grub-66.hasura.app/v1/graphql', {
    headers: {
        'content-type': 'application/json',
        'x-hasura-admin-secret': 'IE71wuGAOuSfZjQYQVeKAenxqjgtDL8bZ9vk1StYGSNFUtzt7MYv7KZOZn0LNGof',
    }
})
